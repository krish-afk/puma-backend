...
router.post('/upload-pdf/:username', upload.single('file'), async (req, res) => {
    ...
    try {
        ...
        const updatedStudent = await Student.findOneAndUpdate(
            ...
            { $push: { transcripts: { $each: transcript } } }, // push the new transcript data to the transcripts array
...
const Student = require('./path/to/studentModel'); // path to your student model
